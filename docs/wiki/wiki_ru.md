...
*Ищите дополнительную помощь на нашем [Website](https://www.coctohug.xyz/) / [Github](https://github.com/raingggg/coctohug) / [Discussions](https://github.com/raingggg/coctohug/discussions) / [Discord](https://discord.gg/2QHx9yT5)*.
...
- Чтобы ускорить синхронизацию вашего узла: [https://www.coctohug.xyz/](https://www.coctohug.xyz/) предоставляет ссылки на файлы базы данных, разработанные и спонсируемые: [Maize fork](https://chiaforksblockchain.com/)
  ```
  ...
  Примечания 1. Блокчейн кошелька вашего форка требует индивидуальной синхронизации в программе форка.
