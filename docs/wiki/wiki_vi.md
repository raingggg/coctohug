...
*Tìm kiếm thêm trợ giúp về [Website](https://www.coctohug.xyz/) / [Github](https://github.com/raingggg/coctohug) / [Discussions](https://github.com/raingggg/coctohug/discussions) / [Discord](https://discord.gg/2QHx9yT5)*.
...
- Để tích lũy đồng bộ hóa nút của bạn, [https://alltheblocks.net/](https://alltheblocks.net/) cung cấp danh sách các nút và tệp cơ sở dữ liệu (nhấp vào từng chuỗi khối và sau đó bạn có thể tìm thấy chúng ở phần trên cùng bên phải)
