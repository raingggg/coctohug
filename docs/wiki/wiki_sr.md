...
*Потражите додатну помоћ на нашем [Website](https://www.coctohug.xyz/) / [Github](https://github.com/raingggg/coctohug) / [Discussions](https://github.com/raingggg/coctohug/discussions) / [Discord](https://discord.gg/2QHx9yT5)*.
...
- Да бисте убрзали синхронизацију чвора: [https://www.coctohug.xyz/](https://www.coctohug.xyz/) пружа везе до датотека базе података - развијене и спонзорисане од: [Maize fork](https://chiaforksblockchain.com/)
  ```
  ...
  Напомене 1: Блок ланца новчаника вашег форк-а треба индивидуалну синхронизацију у програму форк
