...
- Щоб прискорити синхронізацію вузла: [https://www.coctohug.xyz/](https://www.coctohug.xyz/) надає посилання на файли бази даних - розроблено та спонсоровано: [Maize fork](https://chiaforksblockchain.com/)
  ```
  ...
  Примітки 1. Блокчейн гаманця вашого форка потребує індивідуальної синхронізації в програмі fork
  Примітки 2. Підключення завантаженої бази даних до вашої блокчейну може тривати до 5 хвилин!
  ```
