...
راه اندازی آسان با استفاده از [شروع سریع](https://www.coctohug.xyz/) & [مدیر فرماندهی Coctohug](../ccm/ccm_fa.md)
...
- صادرات حساب کیف پول سرد
  ...
  8. 24 کلمه یادگاری را با اسکریپت ترمینال مشابه دریافت کنید (همه فورک های بلاک چین باید 24 کلمه یادگاری یکسانی را به اشتراک بگذارند)
