...
Einfache Einrichtung mit [Schnellstart](https://www.coctohug.xyz/) & [Coctohug Command Manager](../ccm/ccm_de.md)
...
- Cold Wallet-Konto exportieren
  ...
  6. Besuch http://localhost:12630/, und gehen Sie zu Einstellungen - Registerkarte Cold Wallet, um die Cold Wallet-Adressen zu exportieren
  7. Bestätigen Sie manuell, dass jede Adresse korrekt ist, indem Sie die heruntergeladene Datei mit den Informationen vergleichen, die auf der Registerkarte „Schlüssel“ angezeigt werden
  8. Erhalten Sie 24 mnemonische Wörter durch ein ähnliches Terminalskript (alle Blockchain-Forks sollten dieselben 24 mnemonischen Wörter teilen)
